...
下表列出最初 14 例。2026-09-10 至 2026-09-15 扩充的 1,170 例（胸部 284、神经 286、腹部 285、骨骼 315）完整逐条清单见 [`data/expanded-case-sources.json`](data/expanded-case-sources.json)。该清单保存病例 ID、Commons 文件页、来源原文说明、作者、许可与许可页、原始 SHA-1、本地 SHA-256、图像尺寸和文件大小；网站详情页会直接显示其中的关键核验信息。

| 病例 | 作者 | 许可 | 原始文件 |
|---|---|---|---|
| 右侧气胸 | Hellerhoff | CC BY-SA 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:09-01-Pneumothorax.png) |
| 心源性肺水肿 | Frank Gaillard | CC BY-SA 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Pulmonary_oedema.jpg) |
| 急性肺动脉栓塞 | Rvahudson | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:CTA_Chest_With_Massive_Pulmonary_Embolism_and_Complete_Occlusion.jpg) |
| 空洞性肺癌 | Jmarchn | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:CT_scan_of_lung_cancer_with_cavitation.png) |
| 左侧基底节区脑出血 | Dahlqvist 等 | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:CT_Scan_BGH.png) |
| 急性硬膜外血肿 | James Heilman, MD | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:EpiduralHematoma.jpg) |
| 多发性硬化 | Favaretto 等 | CC BY 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Axial_DIR_MRI_of_a_brain_with_multiple_sclerosis_lesions.jpg) |
...
扩展的 1,170 例均来自互不相同的 Wikimedia Commons 文件页和原始 SHA-1。最新一批从 502 张候选中筛出 180 张：人工核对文件页的标题与描述、按可识别检查保留单张代表图，并用接触表检查静态层面是否能看到教学病灶。只在描述中附带提到目标病种、实际拍的是鉴别病变、病理图或同一检查相邻层面的候选不计入病例；与既有病例感知哈希距离 ≤1 的候选也已剔除。部分来源只支持一个诊断类别或某一影像征象，因此病例页保留来源说明和单图局限，不反推未公开的患者病史。来源与图片核对不是医学专家签名审校。
