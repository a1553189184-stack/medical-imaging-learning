...
下表列出最初 14 例。2026-09-10 至 2026-09-14 扩充的 990 例（胸部 236、神经 247、腹部 244、骨骼 263）完整逐条清单见 [`data/expanded-case-sources.json`](data/expanded-case-sources.json)。该清单保存病例 ID、Commons 文件页、来源原文说明、作者、许可与许可页、原始 SHA-1、本地 SHA-256、图像尺寸和文件大小；网站详情页会直接显示其中的关键核验信息。
...
扩展的 990 例均来自互不相同的 Wikimedia Commons 文件页和原始 SHA-1。新增的 304 例还要求来源说明或文件名直接命中其教学诊断，并经感知哈希和缩略图联系表复核；与既有病例感知哈希距离 ≤1 的候选、标注版/未标注版、正常/鉴别图、病理切片和不适合作为影像教学的候选均已替换。部分来源只支持一个诊断类别或某一影像征象，因此病例页明确保留来源说明和单图局限，不反推未公开的患者病史。
